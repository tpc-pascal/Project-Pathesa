...
3.  **Commit:** Sử dụng tiếng Việt hoặc tiếng Anh, nhưng phải rõ nghĩa.
    * *Ví dụ:* `feat: bổ sung cơ chế vật lý mới`
...
* [Mở một Issue](https://github.com/tpc-pascal/Project-Pathesa/issues) trên repo này.
* Gửi câu hỏi qua phần [Thảo luận (Discussions)](https://github.com/tpc-pascal/Project-Pathesa/discussions) của dự án.
